        ...
        <nav class="mb-5">
            <ul class="pagination justify-content-end">
                ...
                if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=mahasiswa-show&halaman=' . $link_prev . '" aria-label="revious"><span aria-hidden="true">&laquo;</span></a></li>';
                }
